...
export default {
  ...
  methods: {
    ...
    getmarker(value, adcode, name) {
      ...
      //   marker.setOffset(new AMap.Pixel(0, -60))
      // })
    ...
    markHighLight(code) {
      this.markerList.forEach(marker => {
        console.log(marker, 'ddddddddddd')
        // if (marker.Ce.title === name) {
        //   marker.setIcon(require('@assets/images/marker2.svg'));
        //   marker.setOffset(new AMap.Pixel(-11, -34.5));
        //   this.createInfoWindow(marker);
        // } else {
        //   marker.setIcon(require('@assets/images/marker1.svg'));
        //   marker.setOffset(new AMap.Pixel(-9, -31));
        // }
      })
    },
    getDetail() {
