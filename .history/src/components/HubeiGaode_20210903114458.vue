<template>
  <div id="gaodeMap">
    ...
    <div  class="topTips">
      <div v-for="(item, index) in mapList" :key="index"   @click="goBackCIty(item,index)" :class="['topItem',{'current':currentIndex === index }]">{{item}}</div>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    getCity(adcode) {
      ...
      new AMap.DistrictSearch({
        ...
        console.log(districtList, 'districtListdistrictList')
